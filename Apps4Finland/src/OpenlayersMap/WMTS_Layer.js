 ...
 */
WMTS_Layer = OpenLayers.Class(OpenLayers.Layer.Grid, {
	...
	getURL : function(bounds) {
		 ...
		 * (NLSFI)
		 */
		if(this.layerDef && this.layerDef.tileMatrixSetLinksMap) {
			...
			var tileMatrixSetLimits = tileMatrixSetLink ? tileMatrixSetLink.tileMatrixSetLimitsMap[this.matrix.identifier] : null;
			 ...
			 * tileMatrixSetLimits
			 */
			var inRowRange = tileMatrixSetLimits ? (info.row >= tileMatrixSetLimits.minTileRow && info.row <= tileMatrixSetLimits.maxTileRow) : false;
			var inColRange = tileMatrixSetLimits ? (info.col >= tileMatrixSetLimits.minTileCol && info.col <= tileMatrixSetLimits.maxTileCol) : false;
